...
function NewF2FForm() {
  ...
  const canSubmit = form.benefitPeriodId && form.f2fDate && form.clinicalFindings.trim().length > 0;

  return (
    <div className="max-w-2xl mx-auto px-4 py-8">
      <h1 className="text-2xl font-bold text-gray-900 mb-6">Document Face-to-Face Encounter</h1>

      {!search.periodId && (
        <div className="mb-4 p-3 bg-amber-50 border border-amber-200 rounded-md text-amber-800 text-sm">
          No benefit period selected. Navigate from a recertification blocker to pre-fill the
          period.
        </div>
      )}
      ...
      <div className="bg-white rounded-lg shadow p-6 space-y-5">
        {field(
          "Benefit Period ID",
          "f2f-benefit-period-id",
          <input
            id="f2f-benefit-period-id"
            type="text"
            className={inputCls}
        ...
        {field(
          "Encounter Setting",
          "f2f-encounter-setting",
          <select
            id="f2f-encounter-setting"
            className={inputCls}
        ...
        {field(
          ...
          "f2f-clinical-findings",
          <textarea
            id="f2f-clinical-findings"
