	...
	return (
		<div className="px-4 py-6 max-w-7xl mx-auto">
			...
			<div className="bg-amber-50 border border-amber-200 rounded-md p-3 mb-6 text-sm text-amber-800">
				<strong>CMS Rule (42 CFR §418.22):</strong> Face-to-face encounter required for all
				benefit period 3+ recertifications, within 30 calendar days prior to recertification
				date.
			</div>
