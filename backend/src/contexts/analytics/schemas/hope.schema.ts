    ...
    bims: Type.Optional(
      Type.Object({
        ...
        bimsSummaryScore: Type.Integer({
          ...
          maximum: 15,
          description:
            "C0500: BIMS summary score (13–15=intact, 8–12=moderate impairment, 0–7=severe impairment)",
        }),
      }),
    ),
...
export const HOPEMoodSchema = Type.Object(
  {
    ...
    phqLittleInterest: Type.Optional(HOPEPHQFrequencySchema), // D0200A
    phqFeelingDown: Type.Optional(HOPEPHQFrequencySchema), // D0200B
...
export const HOPEPainSchema = Type.Object(
  {
    ...
    painPresent: Type.Optional(Type.Boolean({ description: "J0300: Pain present in last 7 days" })),
    ...
    otherDiagnoses: Type.Optional(
      Type.Array(
        Type.Object({
          ...
          icd10Code: Type.Optional(Type.String({ pattern: "^[A-Z][0-9A-Z]{1,6}$" })),
        }),
...
export const HOPESpecialTreatmentsSchema = Type.Object(
  {
    ...
    dialysis: Type.Boolean({
      description: "O0100D: Dialysis — note: typically revocation trigger",
    }),
...
export const HOPEParticipationSchema = Type.Object(
  {
    patientParticipated: Type.Boolean({
      description: "Q0100A: Patient participated in assessment",
    }),
    ...
    legalRepresentativeParticipated: Type.Optional(
      Type.Boolean({
        description: "Q0100C: Guardian/legally authorized representative participated",
      }),
    ),
  },
...
export const HOPEReportingPeriodSchema = Type.Object(
  {
    ...
    calendarYear: Type.Integer({
      minimum: 2025,
      description: "Calendar year (HQRP uses Q4 deadlines)",
    }),
    ...
    penaltyApplied: Type.Boolean({
      description: "2% Medicare reduction applied for missed deadline",
    }),
    createdAt: Type.String({ format: "date-time" }),
  },
  {
