					...
					<div className="space-y-4">
						<div className="flex items-center p-4 bg-red-50 border border-red-200 rounded-md">
							...
							<div className="ml-3">
								...
								<p className="text-sm text-red-700">Patient John Doe - IDG meeting is 2 days overdue</p>
							</div>
						</div>
						<div className="flex items-center p-4 bg-yellow-50 border border-yellow-200 rounded-md">
							...
							<div className="ml-3">
								...
								<p className="text-sm text-yellow-700">Patient Jane Smith - NOE must be filed by tomorrow</p>
							</div>
						</div>
					</div>
				</div>
