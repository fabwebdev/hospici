...
export const HOPEHospiceCareIndexSchema = Type.Object(
	{
		...
		indicator1_visitsNearDeath: Type.Number({ minimum: 0, maximum: 1, description: "Rate of visits near death" }),
		...
		indicator5_shortStay: Type.Number({ minimum: 0, maximum: 1, description: "Inverse — lower is better" }),
		...
		indicator8_multipleHospitalizations: Type.Number({ minimum: 0, maximum: 1, description: "Inverse" }),
...
export type HOPEComprehensiveAssessmentMeasure = Static<typeof HOPEComprehensiveAssessmentMeasureSchema>;
