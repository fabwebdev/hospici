...
**Design System:** See [`docs/design-system.md`](../design-system.md) for all UI components, OKLCH tokens, CMS compliance UI (IDG modal, cap banner), and clinical patterns.
